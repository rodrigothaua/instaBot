...
nomedeusuario = input("Informe o nome de usuário: ")
senha = input("Informe a senha: ")
hash = input("Informe a hashtag que deseja usar: ")
...
class InstagramBot:
    ...
    def type_like_a_person(sentence, single_input_field):
        ...
        print("Digitando a mensagem na área de texto de mensagens")
    ...
    def curtir_fotos_com_a_hastag(self, hashtag):
        ...
        print("A #hashtag " + hashtag + ", existe " + str(len(pic_hrefs)) + " fotos.")
        testes = [
            href
